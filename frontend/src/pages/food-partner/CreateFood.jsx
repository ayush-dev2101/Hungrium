...
const CreateFood = () => {
  ...
  const openFileDialogue = () => fileInputRef.current?.click();
      ...
      <div className="create-food-card">
        <header className="create-food-header">
          ...
          <p className="create-food-subtitle">
            Upload a short video, name and add a description
          </p>
        </header>
        ...
        <form className="create-food-form" onSubmit={onSubmit}>
          <div className="field-group">
            ...
            >
              <div className="file-dropzone-inner">
                ...
                <div>MP4, WebM, MOV • Up to ~100MB</div>
              </div>
            </div>
            {fileError && (
          ...
          <div className="field-group">
            ...
            <textarea
              id="foodDesc"
              rows={4}
              placeholder="Write short description: ingredients, taste, spice level, etc."
              value={description}
              onChange={(e) => {
